...
parm.c2_offset = 0.000002; %threshold offset above median square of correlation coefficient
...
parm.durLong_s = 11; %duration >= durAfter_s (s) will be eliminated
parm.durShort_s = 0.03; %duration >= dur_s (s) will be eliminated


BaseDir = uigetdir('E:\','Please select main folder with xwavs');
mkdir('E:\','Airguns')
DetDir = fullfile('D:\','Airguns');
...
template = 'E:\Code\Airgun Detector\air_template2.mat';
load(template)
